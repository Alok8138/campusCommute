...
// busPassRouter.post("/passSubmit-form", async (req, res) => {
//     try {
//     console.log(req.body);
//     const newApplication = new BusPass(req.body);
...
//         doc.page.height
//       );
//       gradient.stop(0, "#e0f7fa").stop(1, "#ffffff");
...
//       // Header with project name - using gradient text effect
//       doc
//         .fontSize(30)
//         .font("Helvetica-Bold")
//         .fillColor("#1565c0")
...
//       // Student details section with improved styling
//       const detailsTop = 140;
//       const labelWidth = 120;

//       // Add student photo placeholder with better styling
//       doc
...
//       // Details with better formatting and more appealing colors
//       const detailsX = 180;
...
//       // Validity section with improved design
...
//       // Create a more appealing validity box
//       doc
...
//       // Terms and conditions section with better styling
...
//         // Draw custom bullet
//         doc.circle(60, y + 4, 2).fill("#0288d1");
...
//       // Draw CampusCommute logo instead of campus logo
//       doc.roundedRect(50, footerY, 150, 60, 5).fillOpacity(0.1).fill("#bbdefb");
//       doc.fillOpacity(1);
...
//         doc.strokeColor("#000080").lineWidth(1.5).stroke();
